...
export default function HerStory() {
	const isHerStory = usePathname().includes('her-story');
	return (
		<>
			{isHerStory && (
				<main className="flex flex-col w-full gap-12 xl:gap-16 max-w-[90rem] mx-auto mt-12">
					<section className="flex flex-col md:flex-row justify-start items-start md:justify-center md:items-center gap-6 w-full mx-auto">
						...
						<div className="flex justify-center items-center px-4 md:p-6 w-full max-w-xl">
							<p>
								We sincerely reject mainstream modesty and believe that the
								Muslimah (female Muslim) is a woman of distinction. She is
								tranquil, honorable, and chased. A woman who is set apart from
								the rest by her dress, her character, and her high moral
								standards. Her distinguishing mark is covering and chastity.
							</p>
						</div>
					</section>
						...
						<div className="flex flex-col gap-4 w-full lg:w-4/7 xl:w-full h-full text-white px-6 md:px-12 xl:px-24 py-12 xl:py-0 lg:order-first">
							...
							<div className="flex flex-col md:flex-row lg:flex-col gap-6 lg:gap-4">
								<p>
									...
									such clarity and enlightenment to my heart. Each page deepened
									my understanding of what it truly means to dress modestly and
									fulfill this beautiful act of worship.
								</p>
								<p>
									As I read, I felt an undeniable pull to share what I had
									learned with others. It all began with dua, countless
									conversations with my family, and a determination to bring
									this vision to life. Maÿaz Collection was born as a way to
									provide meaningful resources like these books and garments
									that support women in covering correctly. Our very first
									product was the “jilbab” garment—a simple, one-piece design
									that flows from the head to the feet—because I had come to
									understand its importance and obligation (wajib).
								</p>
							</div>
						</div>
					</section>
						...
						<div className="flex flex-col justify-center items-center gap-6 w-full">
							...
							<div className="flex flex-col md:flex-row gap4 md:gap-6 lg:gap-4">
								<div className="w-full">
									<p>
										For us as Muslim women covering is a way of life, a source
										of comfort, and an expression of faith. At Maÿaz, we want to
										make that experience feel special. Every piece in our
										collection is designed with care, offering a variety of
										styles that feel fresh, practical, and beautiful.
									</p>
								</div>
								...
								<div className="w-full">
									<p>
										From timeless designs to seasonal favorites, we&apos;re here
										to make modesty effortless and joyful.
									</p>
									<p>
										Our goal is to create garments that don&apos;t just meet
										your needs—they make you feel confident, honored, and
										cherished. Every item is crafted to reflect the balance
										between modesty and elegance because you deserve both.
									</p>
								</div>
							</div>
						</div>
					...
					<section className="relative flex flex-col lg:flex-row justify-end items-center w-full mx-auto lg:max-h-[600px] overflow-hidden">
						...
						<div className="relative lg:absolute flex flex-col lg:flex-col justify-start items-start lg:justify-center w-full lg:w-1/2 h-auto py-12 px-6 md:px-12 lg:p-12 xl:p-12 xl:py-14 text-white bg-mayazDarker border border-mayazDarker/50 bg-opacity-90 backdrop-blur-md">
							...
							<div className="flex flex-col md:flex-row lg:flex-col gap4 md:gap-6 lg:gap-0">
								<p className="pb-4">
									At Maÿaz Collection, we hope to inspire Taqwa—Love, Fear, and
									Hope in Allah—through everything we offer. It&apos;s not just
									about covering; it&apos;s about loving the act of covering and
									finding beauty in it. Our mission is to make it easier for you
									to embrace modesty in a way that feels natural and uplifting.
								</p>
								<p>
									We&apos;re here to support and encourage you, offering pieces
									that align with Islamic values while celebrating your
									individuality. This is my way of spreading dawah, إن شاء الله,
									and helping my sisters feel their absolute best—inside and
									out.
								</p>
							</div>
						</div>
