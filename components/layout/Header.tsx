						...
						<div className="flex w-full items-center justify-between">
							...
							>
								...
								></path>
									...
									{/*<!-- Snipcart (right) -->*/}
									<div className="flex gap-2 md:gap-3 justify-normal w-auto order-2 mr-6 md:mr-0 border-mayaz !z-50">
										<button
											type="button"
										...
										<button
											type="button"
											className="snipcart-customer-signin relative hidden md:flex md:px-0 md:mt-0 py-3 mr-0"
										>
											{/*<Image
												src="/svg/person.svg"
												alt="User Signin"
												...
												className="w-5 h-5 md:h-5 md:w-5 -mt-1"
											/>*/}
											{/*<CircleUserRound strokeWidth={1.75} size={18} />*/}
											<CircleUser strokeWidth={1.75} size={18} />
										</button>
										<button
											type="button"
											className="snipcart-checkout relative flex font-medium rounded-lg text-sm md:pr-5 py-3 text-center md:mr-0"
										>
											{/*<Image
												src="/svg/bag.svg"
												alt="Shopping cart"
												...
												className="w-full h-4 md:h-4 -mt-1"
											/>*/}
											<ShoppingBag strokeWidth={1.75} size={18} />
											<span className="snipcart-items-count absolute bg-mayaz rounded-full px-1.5 ml-2 mt-2.5 text-xs" />
											<span className="snipcart-total-price hidden md:block ml-4" />
										</button>
									</div>
									{/*<!-- Middle Menu -->*/}
									{/* <div
