  ...
  return (
    <section className="flex flex-col md:flex-row justify-center items-center w-full">
      {newestArrival && (
        ...
        >
          <div className="relative flex justify-center items-center gap-4 image-box w-full max-h-[700px] overflow-hidden">
            ...
            <div className="absolute flex flex-col w-auto h-full">
              <div className="flex flex-col h-full gap-6 mb-12 justify-end items-center">
                <span className="flex justify-center items-center text-center w-full text-3xl tracking-[0.25rem] text-white font-essenceAltFont">
      ...
      {newArrival && (
        ...
        >
          <div className="relative flex flex-col justify-center items-center image-box w-full max-h-[700px] overflow-hidden">
            <div>
              <Image
